...
var dob = new Date("01/17/1989");
//calculate month difference from current date in time
var dob_month_diff = Date.now() - dob.getTime();

//convert the calculated difference in date format
var dob_age_dt = new Date(dob_month_diff);

//extract year from date
var dob_year = dob_age_dt.getUTCFullYear();

//now calculate the age of the user
var dob_age = Math.abs(dob_year - 1970);

//display the calculated age
document.getElementById("my-age").innerHTML = dob_age;

var years_experience = new Date("06/11/2013");
//calculate month difference from current date in time
var years_experience_month_diff = Date.now() - years_experience.getTime();

//convert the calculated difference in date format
var years_experience_age_dt = new Date(years_experience_month_diff);

//extract year from date
var years_experience_year = years_experience_age_dt.getUTCFullYear();

//now calculate the age of the user
var years_experience_age = Math.abs(years_experience_year - 1970);

//display the calculated age
document.getElementById("years_experience").innerHTML = years_experience_age - 1;
